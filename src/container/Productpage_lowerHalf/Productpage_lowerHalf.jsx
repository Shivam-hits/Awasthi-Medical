  ...
  return (
    <div className='productpage_lowerHalf'>
        ...
        <div className='part1 product_description'>
            ...
            <div className=''>
                <p>USES OF PANTOP TABLET</p>
                <ul>
                    <li>Treatment of Heartburn</li>
                    <li>Treatment of Gastroesophageal reflux disease (Acid reflux)</li>
                    <li>Treatment of Peptic ulcer disease</li>
                    <li>Treatment of Zollinger-Ellison syndrome</li>
                </ul>
            </div>
            <br />
            <p>
...
export default Productpage_lowerHalf;